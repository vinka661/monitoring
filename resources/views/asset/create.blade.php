              ...
              <form role="form" action="{{ route('storeAsset') }}" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rbdid" name="rbdid" placeholder="RBDID" required>
                  </div>
                  <div class="form-group">
                    <label for="equipment"><strong>Equipment<strong></label><br>
                    <input type="text" class="form-control" id="equipment" name="equipment" placeholder="Equipment" required>
                  </div>
                </div>
                <!-- /.card-body -->
