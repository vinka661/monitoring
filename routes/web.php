...
Route::get('rcfa/addDetilRcfa/{rcfa_id}', 'rcfaController@editDetaill')->name('editDetilRcfa');
Route::post('rcfa/update/{rcfa_id}', 'rcfaController@update')->name('updateRcfa');
Route::post('rcfa/updateDetil/{rcfa_id}', 'rcfaController@updateDetail')->name('updateDetilRcfa');
